...
def update_config_in_supabase(
    ...
    if current_config_data == new_config_data:
        logging.info("Les données Vieillesse Salariale sont inchangées. Mise à jour de 'last_checked_at'.")
        try:
...
def main() -> None:
    ...
    logging.info("--- DÉBUT Orchestrateur Vieillesse Salariale ---")
    ...
    try:
        ...
        logging.info("--- FIN Orchestrateur Vieillesse Salariale ---")
