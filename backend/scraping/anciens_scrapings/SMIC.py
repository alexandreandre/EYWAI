...
def get_tous_les_smic() -> dict | None:
    ...
    try:
        ...
        smic_valeurs = {
            "cas_general": get_smic_horaire_par_cas(
                soup, f"Cas-general-{current_year}", "Cas général"
            ),
            "entre_17_et_18_ans": get_smic_horaire_par_cas(
                soup, f"salaries-entre-17-18-{current_year}", "17-18 ans"
            ),
            "moins_de_17_ans": get_smic_horaire_par_cas(
