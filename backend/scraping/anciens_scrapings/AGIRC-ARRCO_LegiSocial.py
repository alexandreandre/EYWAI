        ...
        for tr in tbl.find_all("tr"):
            ...
            if "retraite tranche 1" in row:
                ...
                if len(pcts) >= 3:
                    ...
                    taux["retraite_comp_t1_patronal"] = pcts[1]
                print(
                    f"  Retraite T1: {taux.get('retraite_comp_t1_salarial')} / {taux.get('retraite_comp_t1_patronal')}"
                )
                ...
                if len(pcts) >= 3:
                    ...
                    taux["retraite_comp_t2_patronal"] = pcts[1]
                print(
                    f"  Retraite T2: {taux.get('retraite_comp_t2_salarial')} / {taux.get('retraite_comp_t2_patronal')}"
                )
                ...
                if len(pcts) >= 3:
                    ...
                    taux["ceg_t1_patronal"] = pcts[1]
                print(
                    f"  CEG T1: {taux.get('ceg_t1_salarial')} / {taux.get('ceg_t1_patronal')}"
                )
                ...
                if len(pcts) >= 3:
                    ...
                    taux["ceg_t2_patronal"] = pcts[1]
                print(
                    f"  CEG T2: {taux.get('ceg_t2_salarial')} / {taux.get('ceg_t2_patronal')}"
                )
            elif "cet" in row:
                ...
                if ("cet_salarial" not in taux) and len(pcts) >= 3:
                    ...
                    print(
                        f"  CET: {taux.get('cet_salarial')} / {taux.get('cet_patronal')}"
                    )
        ...
        for tr in tbl.find_all("tr"):
            ...
            if row.startswith("apec") or "apec" in row:
                ...
                if len(pcts) >= 3:
                    ...
                    taux["apec_patronal"] = pcts[1]
                print(
                    f"  APEC: {taux.get('apec_salarial')} / {taux.get('apec_patronal')}"
                )
                break
