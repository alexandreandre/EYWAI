...
SCRAPER_MANIFEST: tuple[ScraperEntry, ...] = (
    ...
    ScraperEntry(
        name="TAUX_INTERET_LEGAL",
        dir="taux_interet_legal",
    ...
    ScraperEntry(
        ...
        network_flaky=True,
        checks=(
            ScraperCheck(path=["data", "pct_plafond_horaire_ss"], min=0.10, max=0.20),
        ),
    ),
    ScraperEntry(
        name="MALADIE",
    ...
    ScraperEntry(
        ...
        tier="standard",
        network_flaky=True,
        checks=(ScraperCheck(path=["data", "facteur_smic_plafond"], min=3.0, max=6.0),),
    ),
    ScraperEntry(
        name="OETH",
        dir="oeth",
        ...
        tier="standard",
        network_flaky=True,
        checks=(ScraperCheck(path=["data", "taux_obligation"], min=0.0, max=0.10),),
    ),
    ScraperEntry(
        name="REDUCTION_GENERALE",
        dir="reduction_generale",
        config_key="reduction_generale",
        tier="standard",
        network_flaky=True,
        checks=(ScraperCheck(path=["data", "tmin"], min=0.0, max=0.5),),
    ),
    ScraperEntry(
        name="MANDATAIRE",
        dir="mandataire",
    ...
    ScraperEntry(
        name="COMPTES_AVANCES_ACOMPTES",
        dir="comptes_avances_acomptes",
