...
def core_signature(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Note: L'ID 'fnal' n'est pas vérifié ici car les scrapers FNAL
    # ne renvoient pas un payload de cotisation complet, juste les sections.
...
def debug_comparison(payloads: List[Dict[str, Any]], sigs: List[Dict[str, Any]]) -> None:
    ...
    for p, s in zip(payloads, sigs):
        ...
        moins_50 = s.get("patronal_moins_50", "N/A")
...
def apply_patch_in_memory(
    ...
    patch_data = {
        "patronal": {
            "taux_moins_50": patch_core["patronal_moins_50"],
            "taux_50_et_plus": patch_core["patronal_50_et_plus"],
        }
    }
