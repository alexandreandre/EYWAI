...
# --- SCRAPER ---
def get_taux_vieillesse_patronal_legisocial() -> tuple[dict | None, str]:
        ...
        for row in table.find("tbody").find_all("tr"):
            ...
            if len(cells) > 4:
                ...
                if "vieillesse déplafonnée" in libelle:
                    ...
                    if taux is not None:
                        print(
                            f"  - Taux Vieillesse Déplafonnée (patronal) trouvé : {taux * 100:.2f}%",
                            file=sys.stderr,
                        )
                    ...
                    if taux is not None:
                        print(
                            f"  - Taux Vieillesse Plafonnée (patronal) trouvé : {taux * 100:.2f}%",
                            file=sys.stderr,
                        )
...
def main():
    ...
    taux_data, resolved_url = get_taux_vieillesse_patronal_legisocial()
