...
class ExportGeneratorPort(Protocol):
    ...
    def preview(self, company_id: str, period: str, **kwargs: Any) -> Dict[str, Any]: ...
...
class ExportHistoryRepositoryPort(Protocol):
    ...
    def get_by_id(self, export_id: str, company_id: str) -> Optional[Dict[str, Any]]: ...
    def list_by_company(self, company_id: str, export_type: Optional[str], period: Optional[str], limit: int) -> List[Dict[str, Any]]: ...
