...
DEFAULT_CHECKLIST_ITEMS: List[Dict[str, Any]] = [
    {
        ...
        "item_label": "Restitution du badge d'accès",
        "item_description": "Le salarié doit restituer son badge d'accès aux locaux",
    ...
    },
    {
        ...
        "item_label": "Restitution du matériel informatique",
        "item_description": "Ordinateur portable, téléphone, accessoires, etc.",
        "item_category": "materiel",
        "is_required": True,
        "display_order": 1,
    },
    {
        "item_code": "email_deactivation",
        "item_label": "Désactivation de l'adresse email professionnelle",
        "item_description": "Configurer le transfert ou la réponse automatique puis désactiver",
        "item_category": "acces",
        "is_required": True,
        "display_order": 2,
    },
    {
        "item_code": "access_revocation",
        "item_label": "Révocation des accès aux systèmes",
        "item_description": "Supprimer les accès aux applications, VPN, serveurs, etc.",
        "item_category": "acces",
        "is_required": True,
        "display_order": 3,
    },
    ...
    {
        "item_code": "work_certificate",
        "item_label": "Certificat de travail",
        "item_description": "Document obligatoire (Article L1234-19)",
        "item_category": "legal",
        "is_required": True,
        "display_order": 5,
    },
    {
        "item_code": "unemployment_certificate",
        "item_label": "Attestation Pôle Emploi",
        "item_description": "Nécessaire pour les allocations chômage",
        "item_category": "legal",
        "is_required": True,
        "display_order": 6,
    },
    {
        "item_code": "final_settlement",
        "item_label": "Solde de tout compte",
        "item_description": "Récapitulatif des sommes versées (Article D1234-7)",
        "item_category": "legal",
        "is_required": True,
        "display_order": 7,
    },
...
def create_default_checklist_sync(
    ...
    items = [
        {"exit_id": exit_id, "company_id": company_id, **item}
