...
def generate_demission_solde(
    ...
    montant_conges = socle_commun.build_conges_section(story, styles, indemnities, section_number=2)
    ...
    if notice_period > 0 and not is_gross_misconduct:
        ...
        preavis_text = "Aucun préavis" if notice_period == 0 else f"Préavis de {notice_period} jours"
    ...
    data_preavis = [
        ...
        ['Indemnité compensatrice de préavis', preavis_text_comp,
