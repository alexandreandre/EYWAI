...
def generate_generic_solde(
    ...
    data_indemnites = [["<b>Description</b>", "<b>Montant</b>"]]
    ...
    if indemnities.get("indemnite_preavis", {}).get("montant", 0) > 0:
        ...
        data_indemnites.append(
            ["Indemnité compensatrice de préavis", pdf_helpers.format_currency(montant)]
        )
    ...
    if indemnities.get("indemnite_licenciement", {}).get("montant", 0) > 0:
        ...
        data_indemnites.append(
            ["Indemnité légale de licenciement", pdf_helpers.format_currency(montant)]
        )
        total_general += montant
