...
class ISeizureRepository(ABC):
    ...
    @abstractmethod
    def update(
        self, seizure_id: str, data: Dict[str, Any]
...
class IAdvanceRepository(ABC):
    ...
    @abstractmethod
    def update(
        self, advance_id: str, data: Dict[str, Any]
    ) -> Optional[Dict[str, Any]]: ...
...
class ISeizuresAdvancesCalculator(ABC):
    ...
    def calculate_seizable_amount(
        self, net_salary: Decimal, dependents_count: int = 0
    ) -> Decimal: ...

    @abstractmethod
    def apply_priority_order(
        self, seizures: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]: ...
