...
class ICSEPdfProvider(ABC):
    ...
    def generate_convocation(self, meeting_data: Dict[str, Any]) -> bytes:
        ...
    @abstractmethod
    def generate_minutes(self, meeting_data: Dict[str, Any], transcription: Optional[str] = None, summary: Optional[Dict] = None) -> bytes:
        ...
    @abstractmethod
    def generate_election_calendar(self, cycle_data: Dict[str, Any], timeline: List[Dict[str, Any]]) -> bytes:
        ...
