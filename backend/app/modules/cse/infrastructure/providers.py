...
class CSEPdfProvider(ICSEPdfProvider):
    ...
    def generate_election_calendar(
        ...
        from app.modules.cse.infrastructure.cse_pdf_impl import generate_election_calendar_pdf
...
class CSEExportProvider(ICSEExportProvider):
    ...
    def export_delegation_hours(
        ...
        from app.modules.cse.infrastructure.cse_export_impl import export_delegation_hours
        return export_delegation_hours(hours, summary)

    def export_meetings_history(self, meetings: List[Dict[str, Any]]) -> bytes:
        from app.modules.cse.infrastructure.cse_export_impl import export_meetings_history
