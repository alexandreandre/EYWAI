...
def create_elected_member(
    company_id: str, data: Any, created_by: Optional[str] = None
) -> Any:
    from app.modules.cse.infrastructure.cse_service_impl import (
        create_elected_member as _create,
    )
...
def update_elected_member(member_id: str, data: Any, company_id: str) -> Any:
    from app.modules.cse.infrastructure.cse_service_impl import (
        update_elected_member as _update,
    )
...
def create_delegation_hour(
    company_id: str, employee_id: str, data: Any, created_by: str
) -> Any:
    from app.modules.cse.infrastructure.cse_service_impl import (
        create_delegation_hour as _create,
    )
...
def create_election_cycle(company_id: str, data: Any) -> Any:
    from app.modules.cse.infrastructure.cse_service_impl import (
        create_election_cycle as _create,
    )
