...
class TestExtractTextFromPdf:
    ...
    def test_returns_tuple_text_and_method(self, mock_pdf_extractor: MagicMock):
    ...
    def test_delegates_to_infrastructure(self, mock_pdf_extractor: MagicMock):
    ...
    def test_ocr_method_returned_when_used(self, mock_pdf_extractor: MagicMock):
