...
@patch("app.shared.infrastructure.documents.text_extraction._image_to_png_bytes", return_value=b"png-bytes")
...
def test_render_single_image(mock_ocr, mock_image_cls, _mock_png):
    mock_img = MagicMock()
    mock_image_cls.open.return_value = mock_img
    mock_ocr.return_value = ("DUPONT 42", 6)
