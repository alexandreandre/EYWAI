...
import {
  ...
  type FormationTabId,
} from "@/pages/formation/formationTabRouting";
import type { ParametresSubTab } from "@/pages/formation/tabs/ParametresTab";

const LazyPilotageTab = lazy(() => import("@/pages/formation/tabs/PilotageTab"));
const LazyFormationsTab = lazy(() => import("@/pages/formation/tabs/FormationsTab"));
const LazyConformiteTab = lazy(() => import("@/pages/formation/tabs/ConformiteTab"));
const LazyAnnualReviews = lazy(() => import("@/pages/AnnualReviews"));
const LazyDeveloppementTab = lazy(() => import("@/pages/formation/tabs/DeveloppementTab"));
const LazyParametresTab = lazy(() => import("@/pages/formation/tabs/ParametresTab"));
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          Piloter formations, conformité et entretiens.
        </p>
      </div>
