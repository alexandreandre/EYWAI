...
import { CompanyPageHeader } from "@/pages/company/components/CompanyPageHeader";
import { CompanyComplianceBand } from "@/pages/company/components/CompanyComplianceBand";
import { CompanyRhStatsBand } from "@/pages/company/components/CompanyRhStatsBand";
import { CompanyPilotageSection } from "@/pages/company/components/CompanyPilotageSection";
import { CompanyIdentityTab } from "@/pages/company/components/CompanyIdentityTab";
import { CompanyPayrollTab } from "@/pages/company/components/CompanyPayrollTab";
import { CompanyGroupPositionBand } from "@/pages/company/components/CompanyGroupPositionBand";
import MutuelleManagementTab from "@/pages/company/components/MutuelleManagementTab";
import DocumentLibraryTab from "@/pages/company/components/DocumentLibraryTab";
import { useCompanyPeriod } from "@/pages/company/hooks/useCompanyPeriod";
import { computePeriodPayroll } from "@/pages/company/lib/companyPeriodKpis";
...
export default function CompanyPage() {
  ...
  const canEdit = useMemo(() => {
    const r = user?.role;
    return r === "admin" || r === "rh" || r === "super_admin";
  }, [user?.role]);
