...
export function GroupDashboard() {
  ...
  const exportToCSV = () => {
    ...
    link.download = `groupe_${groupDetails?.group_name ?? groupId}_${periodBounds.endYear}_${periodBounds.endMonth}.csv`;
    link.click();
  };
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-bold tracking-tight">{groupTitle}</h1>
