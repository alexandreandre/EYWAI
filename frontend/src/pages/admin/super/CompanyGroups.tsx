 ...
 * - Créer le groupe unique (une seule fois)
 * - Accéder au détail du groupe
 */
...
export default function CompanyGroups() {
  ...
  const canCreateGroup = groups.length === 0;
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        description={
          canCreateGroup
            ? "Créez le groupe unique regroupant les entreprises du périmètre."
            : "Périmètre unique — gérez les entreprises rattachées au groupe."
        }
        actions={canCreateGroup ? createGroupDialog : undefined}
      />
      ...
      {groups.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-semibold mb-2">Aucun groupe configuré</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Un seul groupe est prévu sur la plateforme. Créez-le pour rattacher vos entreprises.
            </p>
            {canCreateGroup ? (
