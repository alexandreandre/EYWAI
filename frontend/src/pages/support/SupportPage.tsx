...
export default function SupportPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 pb-12">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Contacter le support</h1>
        <p className="text-muted-foreground mt-1 text-sm">
          Décrivez votre besoin en quelques étapes. Réponse habituelle sous 24 à 48 h ouvrées.
        </p>
      </div>
