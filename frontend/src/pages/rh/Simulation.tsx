...
const Simulation: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <RhPageHeader
        title="Simulation de Paie"
        description="Calculez le brut depuis un net cible ou simulez des bulletins de paie"
      />

      {/* Onglets principaux */}
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="mb-6 grid w-full grid-cols-1 gap-1 sm:grid-cols-2 lg:grid-cols-3">
