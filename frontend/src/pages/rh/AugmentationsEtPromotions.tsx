...
export default function AugmentationsEtPromotions() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <RhPageHeader
        title="Augmentations & Promotions"
        description={`Pilotez les augmentations de salaire (collectives ou par avenant) et les promotions de carrière depuis un seul registre.${activeCompany?.company_name ? ` — ${activeCompany.company_name}` : ''}`}
      />
