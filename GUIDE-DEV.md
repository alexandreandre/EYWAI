...
| **`/test-complet`**    | Matrice exhaustive de scénarios pour une page / parcours.                                                                                                                                                                                                                                                                   |
| **`/check-feature`**   | Vérifier qu’une fonctionnalité décrite est bien en place (front, back, tests) : skill `check-feature`.                                                                                                                                                                                                                       |
| **`/is-fonctionnel`**  | Vérifier de façon fiable qu’une implémentation est réellement utilisable.                                                                                                                                                                                                                                                   |
| **`/etat`**            | Bilan Git local vs `origin` / `main` : skill `etat`.                                                                                                                                                                                                                                                                       |
| **`/resume`**          | Résumer en une phrase courte ce qui vient d’être implémenté.                                                                                                                                                                                                                                                                |
| **`/recap-event`** / **`/recap-depuis-push`** | Liste fonctionnelle point par point (événement ou depuis le dernier push).                                                                                                                                                                                                                                   |
| **`/plan-page`**       | Plan d’amélioration d’une page (product / UX).                                                                                                                                                                                                                                                                              |
| **`/refonte-da`**      | Refonte direction artistique.                                                                                                                                                                                                                                                                                               |
| **`/update-copilot-rh`** | Actualiser l’assistant « Demander à l’IA ».                                                                                                                                                                                                                                                                               |
| **`/elsa`**            | Traiter les retours paie terrain (Elsa).                                                                                                                                                                                                                                                                                    |
| **`/backtest-paie`**   | Backtest paie contre bulletins réels.                                                                                                                                                                                                                                                                                       |
| **Fusion `dev-*` → `main`** | Procédure détaillée : skill `merge-dev-to-main` (fichier `SKILL.md` dans le même dossier).                                                                                                                                                                                                                             |

Les fichiers correspondants sont sous **`.cursor/skills/<nom>/SKILL.md`** (à attacher dans le chat si besoin). Liste à jour aussi dans [`.cursor/README.md`](.cursor/README.md).
